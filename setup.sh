...
apt install x11-repo && apt install wget git neofetch proot-distro papirus-icon-theme virglrenderer-android tigervnc xfce4 xfce4-goodies xfce4-whiskermenu-plugin pavucontrol-qt epiphany exa bat lynx cmatrix nyancat gimp hexchat audacious wmctrl -y && vncserver > /dev/null 2>&1 && vncserver -kill :1 > /dev/null 2>&1 
...
echo "
print_centered_text "Please exit and restart Termux first."
"echo ""
