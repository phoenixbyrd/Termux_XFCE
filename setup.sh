...
pkg update -y
pkg upgrade -y -o Dpkg::Otions::="--force-confold"
...
pkg install git neofetch virglrenderer-android papirus-icon-theme xfce4 xfce4-goodies pavucontrol-qt exa bat cmus wmctrl firefox -y
