...
#Install Webcord
proot-distro login debian --shared-tmp -- env DISPLAY=$DISPLAY wget https://github.com/SpacingBat3/WebCord/releases/download/v4.2.0/webcord_4.2.0_arm64.deb
proot-distro login debian --shared-tmp -- env DISPLAY=$DISPLAY apt install ./webcord_4.2.0_arm64.deb -y
proot-distro login debian --shared-tmp -- env DISPLAY=$DISPLAY rm webcord_4.2.0_arm64.deb
