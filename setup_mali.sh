...
proot-distro login debian --shared-tmp -- env DISPLAY=:1.0 groupadd video || true
...
pkg install git neofetch papirus-icon-theme xfce4 xfce4-goodies pavucontrol-qt exa bat wmctrl tigervnc firefox -y
